...
$(document).ready(function () {
	...
	$('.login-btn').click(function () {
		slideBarHide();
		displayLogin(config('server') + '/Login/Login?popup=true', 'Task Management Login', '400', '540');
	});
	...
	$('.send-invite-btn').click(function () {
		if (LOGGED_USER === false) {
			$('#notification .notification-content').text('You need to login before send invite');
			displayModalPopup('#notification');
		} else {
	...
	$('.upgrade-btn').click(function () {
		if (LOGGED_USER === false) {
			$('#notification .notification-content').text('You need to login before Upgrade');
			displayModalPopup('#notification');
		} else {
