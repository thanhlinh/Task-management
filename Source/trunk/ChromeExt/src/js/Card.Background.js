...
BACKGROUND['create-card'] = function (request, sender, sendResponse) {
...
BACKGROUND['get-all-card'] = function (request, sender, sendResponse) {
...
BACKGROUND['card-move-done'] = function (request, sender, sendResponse) {
...
BACKGROUND['change-card-style'] = function (request, sender , sendResponse) {
